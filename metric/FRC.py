...
def compute_FRC(args, pred, listener_em, val_test='val', neighbour_emotion=''):
    pred = pred
    ...
    if val_test == 'val':
        speaker_neighbour_matrix = np.load(os.path.join(args.dataset_path, neighbour_emotion))
    else:
        speaker_neighbour_matrix = np.load(os.path.join(args.dataset_path, neighbour_emotion))
...
def compute_FRC_mp(args, pred, em, val_test='val', p=1, neighbour_emotion=''):
    # pred: N 10 750 25
    # speaker: N 750 25
    # if val_test == 'val':
    ...
    # if val_test == 'val':
    #     neighbour_matrix = np.load(os.path.join(args.dataset_path, 'person_specific_unmasked_neighbour_emotion_val.npy'))
    # else:
    #     neighbour_matrix = np.load(os.path.join(args.dataset_path, 'person_specific_unmasked_neighbour_emotion_test.npy'))

    if val_test == 'val':
        neighbour_matrix = np.load(os.path.join(args.dataset_path, neighbour_emotion))
    else:
        neighbour_matrix = np.load(os.path.join(args.dataset_path, neighbour_emotion))
...
# def compute_FRC_mp(pred, em, val_test='test', p=1):
#     # pred: N 10 750 25
#     # speaker: N 750 25
#     # if val_test == 'val':
#     #     neighbour_matrix = np.load(os.path.join(args.dataset_path, 'neighbour_emotion_val.npy'))
...
#     if val_test == 'val':
#         neighbour_matrix = np.load(os.path.join('../data/react_clean', 'neighbour_emotion_val.npy'))
#     else:
#         neighbour_matrix = np.load(os.path.join('../data/react_clean', 'neighbour_emotion_test.npy'))

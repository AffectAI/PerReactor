...
val_path = pd.read_csv(os.path.join(root_path, str(args.partition)+'_min.csv'), header=None, delimiter=',')
...
np.save(os.path.join(root_path, 'neighbour_emotion_' + str(args.partition) + '_min.npy'), new_matrix)
